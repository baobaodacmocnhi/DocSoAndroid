...
//        String OPERATION_NAME = "DangXuats_Admin";
    ...
    public String getDSTo(String MaTo) throws XmlPullParserException, IOException {
    ...
    public String getDS_May(String MaTo) throws XmlPullParserException, IOException {
    ...
    public String update_GhiChu(String DanhBo, String SoNha, String TenDuong, String ViTri, String ViTriNgoai, String ViTriHop, String Gieng, String KhoaTu
            , String MauSacChiGoc, String GhiChu, String KinhDoanh, String MaNV) throws XmlPullParserException, IOException {
        ...
        pi = new PropertyInfo();
        pi.setName("KinhDoanh");
        pi.setValue(KinhDoanh);
        pi.setType(String.class);
        request.addProperty(pi);
    ...
    public String ghiChiSo_GianTiep(String ID, String Code, String ChiSo, String TieuThu, String TienNuoc, String ThueGTGT, String PhiBVMT, String PhiBVMT_Thue, String TongCong, String HinhDHN, String Dot, String MaNV, String NgayDS,String Location) throws XmlPullParserException, IOException {
    ...
    public String dangKyQRCode(String DanhBo, String ID) throws XmlPullParserException, IOException {
        String SOAP_ACTION = "http://tempuri.org/dangKyQRCode";
        String OPERATION_NAME = "dangKyQRCode";
        SoapObject request = new SoapObject(WSDL_TARGET_NAMESPACE, OPERATION_NAME);
    ...
    public String getDS_SoLieu_SanLuong(String MaTo,String Nam, String Ky, String Dot) throws XmlPullParserException, IOException {
    ...
    public String getDS_SoLieu_HD0(String MaTo,String Nam, String Ky, String Dot) throws XmlPullParserException, IOException {
